...
public class LendingPool extends Contract {
    ...
    public RemoteFunctionCall<BigInteger> FLASHLOAN_PREMIUM_TOTAL() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_FLASHLOAN_PREMIUM_TOTAL,
                Arrays.<Type>asList(),
    ...
    public RemoteFunctionCall<BigInteger> LENDINGPOOL_REVISION() {
    ...
    public RemoteFunctionCall<BigInteger> MAX_NUMBER_RESERVES() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_MAX_NUMBER_RESERVES,
                Arrays.<Type>asList(),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {
                }));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    ...
    public RemoteFunctionCall<BigInteger> MAX_STABLE_RATE_BORROW_SIZE_PERCENT() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_MAX_STABLE_RATE_BORROW_SIZE_PERCENT,
                Arrays.<Type>asList(),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {
                }));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    ...
    public RemoteFunctionCall<TransactionReceipt> initialize(String provider) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_INITIALIZE,
    ...
    public RemoteFunctionCall<TransactionReceipt> setConfiguration(String asset, BigInteger configuration) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
